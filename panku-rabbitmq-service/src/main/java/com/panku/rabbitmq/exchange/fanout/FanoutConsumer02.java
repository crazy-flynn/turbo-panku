...
public class FanoutConsumer02 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("FanoutConsumer02 等待接受消息，并将消息打印在屏幕上...");
        //接收消息 回调
        DeliverCallback deliverCallback = (consumerTag, message) ->{
            System.out.println("FanoutConsumer02 接收到消息：：" + new String(message.getBody()));
        };
        //取消消息 回调
        CancelCallback cancelCallback = (consumerTag) ->{
            //消费消息被中断
            System.out.println("FanoutConsumer02 消费消息被中断");
        };
